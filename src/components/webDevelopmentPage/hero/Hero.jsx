    ...
    <>
      ...
      >
        <div className="flex flex-col items-center gap-6 md:flex-row md:items-start md:~md:~gap-6/48">
          <div
            className="flex flex-col items-center justify-center text-center gap-y-6 md:text-left md:items-start"
          >
            {/* Main Text */}
            <motion.div
              variants={fadeInUpVariants}
            >
              <h1 className="~sm/xl:~text-2xl/6xl font-bold" style={{ lineHeight: '1.2' }}>
