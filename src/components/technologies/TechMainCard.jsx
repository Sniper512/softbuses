...
const TechMainCard = ({ title, icon, bg, href }) => {
  return (
    <a href={href} target="_blank" className="min-w-48 w-48 sm:min-w-[21rem] sm:w-[21rem] col-span-2 row-span-2 bg-dark border ~rounded-xl/2xl flex flex-col items-center justify-between ~p-3/6 brightness-75 transition-transform group hover:border-primary hover:brightness-100">
