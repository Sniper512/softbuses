...
const TechMainCard = ({ title, icon, bg, href }) => {
  return (
    <a href={href} target="_blank" className="min-w-48 w-48 sm:min-w-[21rem] sm:w-[21rem] col-span-2 row-span-2 bg-dark border ~rounded-xl/2xl flex flex-col gap-4 items-center justify-between p-6 transition-transform group hover:border-primary hover:text-primary hover:shadow-glow-2">
