...
export const HeaderMobile = () => {
	...
	const toggleBtnScale =
		toggleBtnMax - (toggleBtnMax - toggleBtnMin) * progress;
		...
		<>
			...
			>
				...
				>
					{/* Logo */}
					<motion.div
						style={{ width: logoWidth, transition: "width 0.2s" }}
			...
			{/* Mobile Menu Overlay */}
			<div
				className={`md:hidden fixed top-0 right-0 h-full w-4/5 bg-dark border-l border-primary/20 z-40 transition-all duration-300 ease-out ${
