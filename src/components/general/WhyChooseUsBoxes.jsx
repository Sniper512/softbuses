          ...
          <motion.ul
            ...
            <div className="flex flex-col sm:flex-row justify-center ~sm/lg:~gap-y-10/16 ~sm/lg:~gap-x-6/11 max-w-2xl mx-auto">
              {featuresData.slice(3, 5).map((feature, index) => (
                <div
                  key={index + 3}
                  className="w-full max-w-[350px] flex flex-col items-center justify-center text-center border border-white/60 hover:border-primary gap-y-4 py-4 px-3 rounded transition-colors duration-500 ease-out"
                >
                  <div className="w-10 h-auto">
                    <img src={`${imgSrc}/${feature.icon}.svg`} alt="" />
                  </div>
